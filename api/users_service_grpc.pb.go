...
func (c *usersServiceClient) Get(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedUsersServiceServer) Get(context.Context, *UserID) (*User, error) {
...
func _UsersService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).Get(ctx, req.(*UserID))
	}
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/users_service.proto",
}
