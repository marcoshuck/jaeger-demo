...
type TweetsServiceClient interface {
	Get(ctx context.Context, in *TweetID, opts ...grpc.CallOption) (*Tweet, error)
}
...
func (c *tweetsServiceClient) Get(ctx context.Context, in *TweetID, opts ...grpc.CallOption) (*Tweet, error) {
	out := new(Tweet)
	err := c.cc.Invoke(ctx, "/api.TweetsService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTweetsServiceServer) Get(context.Context, *TweetID) (*Tweet, error) {
...
func _TweetsService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TweetID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TweetsServiceServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.TweetsService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TweetsServiceServer).Get(ctx, req.(*TweetID))
	}
...
var TweetsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.TweetsService",
	HandlerType: (*TweetsServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Get",
			Handler:    _TweetsService_Get_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/tweets_service.proto",
}
